...
final public class EmailUtils {
    ...
    static {
        ...
        //获取配置文件的path
        String path = Objects.requireNonNull(EmailUtils.class.getClassLoader().getResource("email/email.properties")).getPath();
        ...
        try (FileInputStream inputStream=new FileInputStream(path);){
            ...
            sender.setPort(Integer.parseInt(properties.getProperty("email.port")));
